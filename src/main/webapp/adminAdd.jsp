	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				<li><a href="adminHome.jsp"><fmt:message key="Main_Page" /></a></li>
				<li class="active"><a href="adminAdd.jsp"><fmt:message
							key="Add_User" /></a></li>
			</ul>
			...
			<div class="loginInp">
				<div class="form-group">
					<label for="login"><fmt:message key="Login" /></label> <br> <input
						id="login" type="text" class="form-control" pattern="[a-zA-Z]+"
						name="login" placeholder="Login" maxlength="30"
				...
				<div class="form-group">
					...
					<br> <input type="password" class="form-control"
						pattern="^[0-9a-zA-Z]+$" name="password1" id="password1"
